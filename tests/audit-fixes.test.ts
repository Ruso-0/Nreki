...
// (FIX 8+9 VectorIndex Optimization + RRF Scoring removed v11.0.0:
//  searchHybrid/searchVector amputated with embeddings.)
...
// (v2.2 FIX 4 fastSimilarity tests removed v11.0.0: function amputated
//  with VectorIndex.)
