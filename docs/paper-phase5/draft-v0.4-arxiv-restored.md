...
GitHub: [Ruso-0](https://github.com/Ruso-0)  
Project: [@ruso-0/nreki](https://github.com/Ruso-0/nreki)  
Version tag: [v11.0.0](https://github.com/Ruso-0/nreki/tree/v11.0.0)
...
NREKI is released as open-source software under Apache License 2.0. Source code, evaluation scripts, paper supplementary data, and reproduction artifacts are available in the public repository at https://github.com/Ruso-0/nreki. The arXiv reproducibility snapshot is pinned to the v11.0.0 GitHub tag: https://github.com/Ruso-0/nreki/tree/v11.0.0. The package identifier is `@ruso-0/nreki`. The hybrid-runner Late-Fusion implementation resides at `scripts/eval-phase5/runners/hybrid-runner.ts`; deterministic tie-breaking is implemented at lines 78-81. The `VOYAGE_MODEL` constant is verified at `scripts/eval-phase5/runners/voyage-runner.ts` line 32.
...
Raw artifacts are included in `docs/paper-phase5/supplementary/data/` and are pinned in the public v11.0.0 repository tag.
...
[22] GitHub Docs. "About repository languages." GitHub Docs, accessed May 2026. https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-repository-languages
...
[41] tirth8205. "tirth8205/code-review-graph." GitHub repository, accessed May 2026. https://github.com/tirth8205/code-review-graph

[42] CodeGraphContext. "CodeGraphContext/CodeGraphContext." GitHub repository, accessed May 2026. https://github.com/CodeGraphContext/CodeGraphContext

[43] DeusData. "DeusData/codebase-memory-mcp." GitHub repository, accessed May 2026. https://github.com/DeusData/codebase-memory-mcp
...
[45] ZillizTech. "zilliztech/claude-context." GitHub repository, accessed May 2026. https://github.com/zilliztech/claude-context
