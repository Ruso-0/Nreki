...
- NEVER use Bash grep/rg or native Read. Use `nreki_navigate action:"fast_grep"` for exact search, `action:"search"` for semantic.
...
- **80L limit:** Decompose payloads >80 lines. **Patch mode:** Use `search_text`/`replace_text` for symbols >40L.
