...
- NEVER use Bash grep/rg or native Read. `nreki_navigate action:"fast_grep"` for exact search, `action:"search"` for semantic.
...
- 80L guillotine + patch mode (symbols >40L). ACID: every `search_text` targets ORIGINAL source.
